...
const defaultCategories: Category[] = [
  ...
  { id: '6', name: 'Beverages', color: '#a78bfa', icon: 'Coffee' },
  ...
  { id: '10', name: 'Pantry', color: '#a3e635', icon: 'Container' },
];

const defaultQuickAddItems: QuickAddItem[] = [
  { id: '1', name: 'Milk', category: '3' },
  { id: '2', name: 'Bread', category: '7' },
  { id: '3', name: 'Eggs', category: '3' },
  { id: '4', name: 'Bananas', category: '2' },
  { id: '5', name: 'Toilet Paper', category: '8' },
  { id: '6', name: 'Coffee', category: '6' },
  { id: '7', name: 'Tomatoes', category: '1' },
